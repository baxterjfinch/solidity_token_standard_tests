...
contract Atlas is ERC721Token, Ownable {
  ...
  ERC20Interface acceptedToken = ERC20Interface(0xFDE3726d7d2919FB7de674CB719Ac6c856A998Db);
  ...
  function removeFromSale(uint256 _tokenId) external {
      ...
      function buyForSaleToken(uint256 _tokenId, uint256 price) external payable {
          address buyer = msg.sender;
          address owner = ownerOf(_tokenId);
          uint payedPrice = price;
          ...
          require(
              acceptedToken.transferFrom(buyer, owner, payedPrice),
              "Transferring the sale amount to the seller failed"
          );
